...
namespace consoleTranslatorTest.TranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private consoleTranslatorTest.TranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public consoleTranslatorTest.TranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        consoleTranslatorTest.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, consoleTranslatorTest.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, consoleTranslatorTest.TranslatorService.Translation[] translations, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        consoleTranslatorTest.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, consoleTranslatorTest.TranslatorService.TranslateOptions options);
        ...
        consoleTranslatorTest.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options);
        ...
        consoleTranslatorTest.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options);
    }
    ...
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<consoleTranslatorTest.TranslatorService.LanguageService>, consoleTranslatorTest.TranslatorService.LanguageService {
        ...
        public consoleTranslatorTest.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, consoleTranslatorTest.TranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, consoleTranslatorTest.TranslatorService.Translation[] translations, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public consoleTranslatorTest.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, consoleTranslatorTest.TranslatorService.TranslateOptions options) {
        ...
        public consoleTranslatorTest.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public consoleTranslatorTest.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, consoleTranslatorTest.TranslatorService.TranslateOptions options) {
